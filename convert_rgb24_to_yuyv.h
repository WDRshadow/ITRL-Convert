...
inline void convert_rgb24_to_yuyv_core(const unsigned char *rgb24, unsigned int starting_node, unsigned char *yuyv422, unsigned int width, unsigned int height)
{
    ...
    for (int y = 0; y < height; y++)
    {
        ...
        {
            const unsigned char r0 = rgb24[index_rgb];
            const unsigned char g0 = rgb24[index_rgb + 1];
            const unsigned char b0 = rgb24[index_rgb + 2];

            const unsigned char r1 = rgb24[index_rgb + 3];
            const unsigned char g1 = rgb24[index_rgb + 4];
            const unsigned char b1 = rgb24[index_rgb + 5];
